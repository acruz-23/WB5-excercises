...
const tableEl = document.querySelector("#winningTicketsTbl tbody");
winningTickets.forEach((ticket) => CreateTableRow(tableEl, ticket));

function CreateTableRow(myTable, ticketObject) {
  ...
  cell1.textContent = ticketObject.tixNum;
  cell2.textContent = `$ ${ticketObject.prize}`;
  cell3.innerHTML = ticketObject.expires;
}
